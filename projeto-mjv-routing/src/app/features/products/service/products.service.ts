...
export class ProductsService {
  ...
  getProducts() {
    return this.httpClient.get<ProductModel[]>(environment.baseURL);
  }

  searchProductByName(name: string) {
    return this.httpClient.get<ProductModel>(environment.baseURL + 'product?name=' + name);
  }

  searchProductById(id: number) {
    return this.httpClient.get<ProductModel>(environment.baseURL + 'product?id=' + id.toString());
  }
